...
@keyframes float-orb {
  ...
  50% { transform: translateY(-15px) translateX(25px) scale(0.95); opacity: 0.5; }
  75% { transform: translateY(-40px) translateX(-10px) scale(1.1); opacity: 0.7; }
}
...
@media (max-width: 480px) {
  ...
  /* Stack footer links as horizontal scroll on mobile */
  .fixed.bottom-4.left-4 .flex.flex-col {
  ...
  .fixed.bottom-4.left-4 .flex.gap-3 {
    gap: 6px !important;
  }
...
@media (max-width: 600px) {
  ...
  /* Ensure dialogs appear above footer links */
  .feedback-pixel-dialog,
  .howtoplay-dialog-content {
...
/* Fix bottom navigation interference */
