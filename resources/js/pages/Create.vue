      ...
      <div class="w-full max-w-sm flex flex-col items-center">
        ...
        <div class="title-wrapper mb-8 text-center">
          ...
          <p class="tagline mt-4 text-cyan-300 text-center text-[10px] md:text-[12px] uppercase tracking-[0.35em]"
            style="font-family: 'VT323', monospace; font-size: 15px;">
            ◇ Begin Your Journey ◇
          </p>
        </div>

        <!-- Register Card - Galaxy Theme -->
        <v-form class="w-full" @submit.prevent="register">
          <div class="galaxy-card relative">
            <!-- Card Glow -->
            <div class="card-glow absolute inset-0 rounded-2xl"></div>
            ...
            <div class="card-body relative px-6 pb-6">
                ...
                <div class="input-wrapper">
                  ...
                  >
                    <template #prepend-inner>
                      <v-icon size="small" class="input-icon">mdi-account-outline</v-icon>
                    </template>
                  </v-text-field>
                </div>
              ...
              <div v-if="passwordMismatch" class="mt-2 text-center">
                <p class="text-red-400 text-xs" style="font-family: 'VT323', monospace; font-size: 14px;">
              ...
              <div class="signup-link mt-5 text-center">
                ...
                <v-btn variant="text" class="login-btn-link px-1" @click="goToHome">
                  Sign in
                </v-btn>
              </div>
            </div>
...
onMounted(() => {
  console.log('Mounting Create.vue, Google Client ID:', googleClientId.value)
